...
aws autoscaling delete-policy --auto-scaling-group-name cli-lab-asg --policy-name cli-lab-cpu-tracking-policy 2>/dev/null || echo "   - Policy already deleted."

echo "2/8 Deleting Auto Scaling Group (Force deleting instances)..."
aws autoscaling delete-auto-scaling-group --auto-scaling-group-name cli-lab-asg --force-delete 2>/dev/null || echo "   - ASG already deleted."
...
aws ec2 delete-launch-template --launch-template-name cli-lab-launch-template 2>/dev/null || echo "   - Launch Template already deleted."
